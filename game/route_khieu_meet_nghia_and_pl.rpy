label route_khieu_meet_nghia_and_pl:
    ...
    show dn surprisedTalk at Transform(xpos=0.5, ypos=0.06)
    
    unknown "Tao chưa bao giờ thấy nó nói nhiều như thế với người mới gặp luôn"
    
    hide dn surprisedTalk
    show dn surprisedNTalk at Transform(xpos=0.5, ypos=0.06)
    ...
    menu:
        "Cảm ơn lòng tốt của Nghĩa và nói sẽ hỏi khi có bài khó":
            mc "Cảm ơn lòng tốt của Nghĩa, mình sẽ hỏi khi có bài khó"
            
            # DOCX parity with Phong-route variant: this choice gives +2 fp ĐN
            $ fp_dn += 2
            ...
            menu:
                "Nói rằng chỉ muốn hỏi Nghĩa thôi":
                    mc "Mình chỉ muốn hỏi Nghĩa thôi"
                ...
                "Nói rằng bạn sẽ cùng làm với Nghĩa và nếu có câu khó sẽ nhờ đến Phong":
                    mc "Mình sẽ cùng làm với Nghĩa và nếu có câu khó sẽ nhờ đến Phong"
        ...
        "Ngưỡng mộ và nói Phong sau này kèm bạn học":
            mc "Phong giỏi vậy, sau này kèm mình học với nha"
    ...
    menu:
        "Đùa với Phong Lê bằng cách gọi là Phong":
            ...
            menu:
                "Vẫn đùa tiếp":
                    ...
                    hide pl sadTalk
                    show pl sadNTalk at Transform(xpos=0.1, ypos=0.06)
                    show dn neutralTalk at Transform(xpos=0.5, ypos=0.06)
        ...
        "Đồng ý và nói sau này sẽ gọi cậu ấy là Phong Lê":
            mc "Được rồi, sau này mình sẽ gọi cậu là Phong Lê"
    ...
    menu:
        "Nói rằng Nghĩa may mắn do có người giúp đỡ":
            mc "Nghĩa may mắn do có người giúp đỡ nhỉ"
        ...
        "Nói rằng ước gì bạn cũng được đi cửa sau giống vậy":
            mc "Ước gì mình cũng được đi cửa sau giống vậy"
