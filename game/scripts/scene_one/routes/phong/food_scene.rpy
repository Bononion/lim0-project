...
## ============================================
## PHONG ROUTE: FOOD SCENE
## First scene in Phong route
## Characters: mc, pl, dn, duyen
## ============================================
...
label route_phong_food_scene:
    ...
    hide pl eating ntalk
    show cd neutral talk at cd_default
...
label phong_continue_tease:
    ...
    show pl sad talk at pl_default
...
label phong_gk_answers:
    ...
    hide gk wakingup talk
    show pl surprised talk at pl_default
