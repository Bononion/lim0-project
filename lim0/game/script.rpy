...
# Characters
image gk normal = "images/GK/gia_khieu_moi_nguday.png"
...
image pl normal = "images/PL/phong_le_neutral.jpg"
...
label game_over_truant:
    ...
    "Vài năm sau, bạn thất nghiệp, sống lay lắt trong căn phòng trọ 3m2, và cuối cùng trở thành streamer review mì gói."
...
label game_over_health:
    ...
    "Màn hình chuyển cảnh, bạn ngồi xuống ghế nhựa, nghe theo tiếng gọi con tim (hoặc dạ dày)."
    
    "Nhưng thời gian trôi nhanh, từng que xiên là từng đơn vị cholesterol."
    
    "Ba năm sau, bác sĩ lắc đầu trong phòng khám: \"Em bị gan nhiễm mỡ độ 3, mỡ máu và huyết áp cao.\""
...
label meet_gia_khieu:
    ...
    "Tay phải đang cầm một cây cá viên chiên chấm sốt, một tay cậu lủng lẳng bịch nilon, bên trong là hai hộp xốp bị dầu thấm ra ngoài còn đang toả hơi nóng, nhìn là biết mới mua."
    
    "Vết nước sốt đỏ au dính lên vạt áo, mà cậu ấy vẫn tỉnh bơ aura walk như thể sắp bước vào buổi hội thảo TED."
    
    "Gương mặt cậu lấm tấm mồ hôi (hoặc nước dãi, không rõ lắm)."
    
    "Có vẻ cái nắng Sài Gòn chiều khiến ai cũng đổ mồ hôi, người nào người nấy như tan chảy trong không khí oi ả — trừ cậu."
    
    "Không phải vì chịu được nóng, mà vì cậu chẳng vội gì để phản ứng với thời tiết. (Chắc là do cậu lười tiết mồ hôi.)"
    ...
    "Trước mắt là một cánh cổng sắt đen đơn giản, không có bảng hiệu nào. Nhưng từ bên trong có tiếng ồn vọng ra, bạn biết mình đã đến đúng chỗ."
    
    "Bạn bước vào trong, cậu học sinh thả đôi dép của mình một cách lộn xộn vào đống giày dép bên phải, bạn thấy vậy cũng để gọn gàng giày của bạn ngay kế bên."
...
label enter_classroom:
    ...
    duyen "Chào con. Con là [player_name], học sinh mới đúng không? Mẹ con có nói chuyện với cô rồi, con học có gì không hiểu thì cứ hỏi cô nhé."
    ...
    "Bạn nhìn theo hướng cô Duyên chỉ và thấy bàn mà Gia Khiếu vừa ngồi xuống. Trên bàn là mớ tờ đề cương gấp lộn xộn, kẹp giữa vài cuốn tập. Ba người đã ngồi sẵn ở dãy bàn đó."
    ...
    "Không khí trầm lắng, chỉ có tiếng cô Duyên giải bài mẫu và âm thanh nhè nhẹ của quạt cùng với mùi xiên bẩn còn vương lại trong không khí."
    ...
    menu choice_seating:
        "Ngồi bên trái (cạnh Nghĩa)":
            $ seating_choice = "nghia"
            $ fp_dn += 1
            jump route_nghia
        
        "Ngồi ở giữa (cạnh Phong)":
            $ seating_choice = "phong"
            $ fp_pl += 1
            jump route_phong
        
        "Ngồi bên phải (cạnh Khiếu)":
...
label route_nghia:
    ...
    dn "À không sao nha ông/bà cứ thoải mái đi."
    ...
    menu:
        "Ừ đúng rồi, mình là [player_name]":
            $ trait_nc += 1
            dn "Tên mình là Nghĩa, rất vui được gặp bà/ông."
...
label route_phong:
    ...
    duyen "Nhanh nhỉ, làm xong nói cô cô cho mới làm tiếp nhé."
    pl "Dạ."
    ...
    dn "Tui là Đại Nghĩa. Đừng để thằng Phong lừa ông/bà, tui không có chôm chỉa gì hết nha."
    pl "hihi"
...
label gia_khieu_sleeping_scene:
    ...
    "Một lúc sau, Gia Khiếu lại gục đầu xuống bàn."
    
    #play sound audio.sfx_snore
    "Tiếng thở đều đều phát ra, cậu ta đã ngủ thiệt."
    
    if seating_choice == "nghia":
        show dn smile at right
        dn "Đấy, nó ngủ lại rồi."
        dn "Bình thường á"
        hide dn
    elif seating_choice == "phong":
        show pl normal at center
        pl "Ê, Khiếu ngủ lại rồi kìa."
        pl "Mà cũng bình thường thôi"
        hide pl
    elif seating_choice == "khieu":
        "Bạn nhìn sang Gia Khiếu, cậu ta đã gục đầu ngủ say."
        mc "/Cậu ta lúc nào cũng ngủ vậy./"
    
    "Khoảng 20 phút sau..."
    
    show duyen at center
    duyen "Giờ các con tự giải bài tập trong đề cương nhé, cô sẽ đi kiểm tra từng bàn."
    duyen "Ai làm xong thì gọi cô, cô sẽ chấm bài."
    hide duyen
    ...
    if seating_choice != "khieu":
        dn "Ê Phong, mày làm xong chưa?"
        pl "Xong rồi, mày sao?"
        dn "Tao cũng xong rồi, nhưng mà không chắc đúng hết."
        pl "Thôi để tra với Khiếu đi."
    else:
        pl "Ê Nghĩa, mày làm xong chưa?"
        dn "Xong rồi, nhưng mà không chắc đúng hết."
        pl "Thôi để tra với Khiếu đi."
    
    "Phong nhẹ nhàng lay vai Gia Khiếu."
    
    pl "Ê Khiếu, dậy tra bài đi."
    
    gk "...ừm..."
    
    "Gia Khiếu từ từ ngẩng đầu lên, mắt vẫn còn lờ đờ."
    
    gk "Câu nào?"
    
    dn "Từ câu 1 đến câu 10."
    
    "Gia Khiếu lấy tập ra, lật qua vài trang."
    
    gk "Câu 1: B, Câu 2: D, Câu 3: A..."
    
    "Cậu ta đọc đáp án một cách máy móc, trong khi Nghĩa và Phong đối chiếu với bài làm của mình."
    
    pl "Úi tao sai câu 5 rồi."
    dn "Tao cũng vậy."
    
    if seating_choice == "standing":
        mc "/Mọi người đều giỏi quá.../"
    else:
        "Bạn cũng theo dõi và đối chiếu với bài làm của mình."
        mc "/Mình cũng sai mấy câu.../"
    
    gk "...xong chưa?"
    dn "Xong rồi, cảm ơn mày nha."
    gk "Ừm."
    
    "Gia Khiếu lại gục đầu xuống bàn."
    
    pl "Nó ngủ lại rồi."
    dn "Kệ nó đi, để nó ngủ."
